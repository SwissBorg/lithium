...
final private[sbr] case class SBReachabilityReporterState private (
  ...
  /**
    ...
    */
  def withReachable(subject: Subject,
                    tagAsRetrieved: Boolean = false): SBReachabilityReporterState = {
  ...
  /**
    ...
    */
  def withUnreachableFrom(observer: Observer,
                          subject: Subject,
  ...
  /**
    ...
    */
  def withContention(protester: Protester,
                     observer: Observer,
                     subject: Subject,
                     version: Version): SBReachabilityReporterState =
    copy(
  ...
  // TODO need version?
  def withoutContention(protester: Protester,
                        observer: Observer,
                        subject: Subject): SBReachabilityReporterState = {
